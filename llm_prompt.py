"""Legacy prompt helpers retained for compatibility with the starter API.

The current implementation does not use an LLM in the default decision path.
These helpers are isolated here so the deterministic policy engine stays separate
from optional future LLM experimentation.
"""
